...
const getItemReport = async (regionId, typeId) => {
	try {
		...
		const dailyFlipProfit = totalFlipProfit / DAYS_CONSIDERED;
...
//https://www.reddit.com/r/Eve/comments/j5kw28/spreadhseet_refine_value_for_loot_items/
...
document.addEventListener('DOMContentLoaded', async () => {
	...
	let html = '';
	html += `Reprocess (region: ${THE_REGION_ID})<br/>`;
	html += '<br/>';
